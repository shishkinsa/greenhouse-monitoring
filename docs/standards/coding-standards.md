...
Правила относятся к SPA **`cnt_gm_web`** и целевой структуре слоёв из [12-frontend-app-architecture.md](../architecture/specs/frontend/12-frontend-app-architecture.md). Именование компонентов и файлов — в [react-naming-conventions.md](react-naming-conventions.md).
