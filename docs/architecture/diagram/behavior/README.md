...
Рекомендуемые имена файлов по [README родительского каталога](../README.md): диапазон **40–49** для поведения; эталон в репозитории: [40-dynamic-employee-live-monitoring.c4](40-dynamic-employee-live-monitoring.c4).
